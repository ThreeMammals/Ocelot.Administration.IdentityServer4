...
public class CacheManagerTests : Steps //IDisposable
{
    ...
    private new void GivenOcelotIsRunning()
    {
    ...
    public void Dispose()
    {
        var cert = Environment.GetEnvironmentVariable("OCELOT_CERTIFICATE");
        var pass = Environment.GetEnvironmentVariable("OCELOT_CERTIFICATE_PASSWORD");
